    ...
    <div class="user-account-properties">
        <div class="user-account-header">
            ...
            <div class="user-account-short-info">
                ...
                <span v-if="props.user.registerDate" style="font-style: italic;">Дата регистрации: {{ helper.getDateString(props.user.registerDate, true) }}</span>
        ...
        <AccountProperty propertyName="Никнэйм" :propertyValue="props.user.nickname" />
        <AccountProperty propertyName="Email" :propertyValue="props.user.email" />
        ...
        <AccountProperty propertyName="О себе" :propertyValue="props.user.info" />
    </div>
</template>
